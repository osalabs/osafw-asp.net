...
Public Class UploadUtils
    ...
    Public Shared Function upload_simple(up As UploadParams) As Boolean
        ...
        If file IsNot Nothing Then
            ...
            up.ext = UploadUtils.get_upload_file_ext(file.FileName)
            ...
            If up.is_resize AndAlso is_upload_img_ext_allowed(up.ext) Then
                Utils.image_resize(up.full_path, up.full_path, up.max_w, up.max_h)
            End If
            result = True
        Else
    ...
    Public Shared Function upload_file(fw As FW, ByVal module_name As String, id As Integer, ByRef filepath As String, Optional input_name As String = "file1", Optional is_skip_check As Boolean = False) As Boolean
        Dim result As Boolean = False
        Dim file As HttpPostedFile = fw.req.Files(input_name)

        If Not IsNothing(file) AndAlso file.ContentLength Then
            Dim ext As String = get_upload_file_ext(file.FileName)
            If is_skip_check OrElse is_upload_img_ext_allowed(ext) Then
                'remove any old files if necessary
                remove_upload_img(fw, module_name, id)

                'save original file
                Dim part As String = get_upload_dir(fw, module_name, id) & "\" & id
                filepath = part & ext
    ...
    Public Shared Function get_upload_file_ext(ByVal filename As String) As String
    ...
    Public Shared Function is_upload_img_ext_allowed(ByVal ext As String) As Boolean
    ...
    ' id splitted to 1000
    Public Shared Function get_upload_dir(fw As FW, ByVal module_name As String, ByVal id As Long) As String
    ...
    Public Shared Function get_upload_url(fw As FW, ByVal module_name As String, ByVal id As Long, ByVal ext As String, Optional size As String = "") As String
    ...
    Public Shared Function get_upload_img_path(fw As FW, ByVal module_name As String, ByVal id As Long, ByVal size As String, Optional ext As String = "") As String
        If size <> "l" And size <> "m" And size <> "s" Then size = "" 'armor +1

        Dim part As String = UploadUtils.get_upload_dir(fw, module_name, id) & "\" & id
    ...
    Public Shared Function get_upload_img_url(fw As FW, ByVal module_name As String, ByVal id As Long, ByVal size As String) As String
        If size <> "l" And size <> "m" And size <> "s" Then size = "" 'armor +1
        ...
        If ext > "" Then
            Return UploadUtils.get_upload_url(fw, module_name, id, ext, size)
        Else
            Return ""
        End If
    End Function
